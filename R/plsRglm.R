...
#' backend. For a polr model (\code{modele="pls-glm-polr"}), \code{logistic}
#' or \code{probit} or (complementary) log-log (\code{loglog} or
#' \code{cloglog}) or \code{cauchit} (corresponding to a Cauchy latent
#' variable).
