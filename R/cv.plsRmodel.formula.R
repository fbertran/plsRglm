...
m <- match(c("formula","data","nt","limQ2set","modele","K","NK","grouplist","random","scaleX","scaleY","keepcoeffs","keepfolds","keepdataY","keepMclassed","tol_Xi","weights","subset","contrasts"), names(mf), 0L)
mf <- mf[c(1L, m)]
