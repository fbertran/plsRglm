...
#' 
#' This function provides a coef method for the class \code{"plsRglmmodel"}
#' 
#' 
...
#' @param \dots not used
#' @return An object of class \code{coef.plsRglmmodel}.\cr
#' \item{CoeffC}{Coefficients of the components.}
#' \item{Std.Coeffs}{Coefficients of the scaled predictors in the regression
