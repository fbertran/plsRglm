...
- Added functions for raw bootstrap. Added feature to support custom
  bootstrap function.
...
- Major upgrade to enhance generics support. Package vignette (130 p.)
  release. Help of package completed.
...
- Code upgrade requested by R Core Team due to change in namespace
  policies.
...
- Graphical assessment of variable selection. Selection of bootstap
  techniques for CI plots.
...
- Cross-validation fully compatible with weighted plsR or plsRglm
  models.
...
- Sparse option to set to 0 the coefficients of non-significant
  predictors and to select the number of components.

## plsRglm 0.6.3

CRAN release: 2011-01-09

- Minor fixes to cope with upcoming changes in R 2.13.

## plsRglm 0.6.2

- Support for logistic, probit, cloglog and cauchit links for cumulative
  link models.
...
- Support for Gamma(link = “inverse”), inverse.gaussian(link = “1/mu^2”)
  and poisson(link = “log”) added.
...
CRAN release: 2010-10-05

- Boostrap functionnalities improvement. Bootstrap no longer stops if
  model fitting fails for some subsample.
